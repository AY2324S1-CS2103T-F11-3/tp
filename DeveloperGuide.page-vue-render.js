...
with(this){return _c('ul',[_c('li',[_c('p',[_v("When called upon to parse a user command, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" class creates an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommandParser")]),_v("\n("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZ")]),_v(" is a placeholder for the specific command name e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddSellerCommandParser")]),_v(") which uses the other classes shown above\nto parse the user command and create a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommand")]),_v(" object (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddSellerCommand")]),_v(") which the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v("\nreturns back as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" object.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" also creates a CommandWarnings object, which is used to handle user errors that do not require the system\nto fail execution of the command (e.g. if user is trying to add seller with a non-alphanumeric name.) If the command inherits\nfrom the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" interface, then it will use this object to store warnings to output into the Command and eventually into\nthe resulting CommandResult. It is also used by LogicManager to log warnings. Classes which do not implement "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" do\nnot use warnings (because they either execute successfully or fail; there is no potential for user misinput.)")])]),_v(" "),_c('li',[_c('p',[_v("All "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommandParser")]),_v(" classes (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommandParser")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommandParser")]),_v(", ...)\ninherit from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" interface so that they can be treated similarly where possible e.g, during testing.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed edit mechanism is facilitated by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command, we can find the seller or buyer to edit.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user types in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit-b")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit-s")]),_v(" keyword, followed by the index of the buyer or seller that they want\nto edit. Following that, they type "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/field")]),_v(", where "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("field")]),_v(" is a name of the field that they want to edit.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The edit command will call the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command to find the corresponding buyer or seller, then it will copy that person,\nedit the field that the user wants to edit, delete that buyer or seller, then add the edited buyer or seller back\ninto the list.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How edit executes:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Deletes the old buyer or seller and adds the edited one.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May not preserve buyer and seller order")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Deletes the old buyer or seller, then copies and deletes all the buyers or sellers\nafter that buyer or seller, then adds the new edited buyer or seller, and then adds back all the copied\nbuyers and sellers.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Preserves order")]),_v(" "),_c('li',[_v("Cons: Difficult to implement")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{more aspects and alternatives to be added}")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"completed-priority-feature"}},[_v("[Completed] Priority feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#completed-priority-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The priority feature is associated with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" commands, allowing the user to assign and sort clients by\ntheir priority levels in the address book. The priority field is optional when instantiating buyers and sellers, and is\ninitially unassigned.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("To implement this feature, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Priority")]),_v(" field is firstly added to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(", and its corresponding UI Label is\nrendered by modifying the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonCard.java")]),_v(" controller and the respective BuyerCard and SellerCard FXML files.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Since the priority field is\noptional, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Buyer")]),_v("/"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Seller")]),_v(" constructor is overloaded, such that the one which does not take in priority as an\nargument will initialise priority to the default "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("nil")]),_v(" level.")]),_v(" "),_c('li',[_v("The priority FXML Label is conditionally rendered\nin "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonCard.java")]),_v(" based on the buyer/seller's priority field. For instance, its color is red for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("high")]),_v(" priority,\norange for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("medium")]),_v(", green for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("low")]),_v(", and not rendered for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("nil")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("To accommodate saving of buyers and sellers with the new priority fields in storage, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JsonAdaptedBuyer")]),_v(" and other\nrelevant files are modified to include these fields in JSON format, and to be readable and loaded back into "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" in\nsubsequent RTPM initialisations.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("To make it more convenient for the user to directly assign priorities to clients without having to use the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v("\ncommand, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SetBuyerPriority")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SetSellerPriority")]),_v(" commands are implemented as part of this feature.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application and executes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority-b 2 high")]),_v(" command, which sets the priority level of the\n2nd person in the buyer list to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("high")]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority-b")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(", which gets "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v("\nto parse and obtain a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SetBuyerPriorityCommand")]),_v(", before executing it. The command execution calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager")]),_v(" to\nupdate the address book's buyer list with the newly assigned buyer priority, which is reflected on the UI too.\nFinally, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("StorageManager")]),_v(" to update the JSON file.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. To unassign the priority level of the 2nd person, the user can execute the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority-b 2 nil")]),_v(" command, which\nruns a similar flow as illustrated in the sequence diagram above.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The same logic can be used for assigning priorities to sellers instead of buyers, by using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority-s")]),_v(" instead\nof "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority-b")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How the optional priority field is implemented")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (initial choice):")]),_v(" Overload the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Buyer")]),_v("/"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Seller")]),_v(" constructors.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Relatively simple to implement and refactor.")]),_v(" "),_c('li',[_v("Cons: Not feasible for implementing various optional fields.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2 (current choice):")]),_v(" Assign a default value for all non-compulsory fields in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddBuyer")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddSeller")]),_v(",\nonly assigning them for arguments available from the parsed user input (in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArgumentMultimap")]),_v(").")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Only a single constructor for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Buyer")]),_v("/"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Seller")]),_v(" is needed for multiple optional fields.")]),_v(" "),_c('li',[_v("Cons: Address book only adds correctly formatted fields and may discard the rest without the user knowing, so\nmore robust exception handling is required in parsing the user input which may be tedious to implement.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"proposed-sort-feature"}},[_v("[Proposed] Sort feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-sort-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed sort mechanism is facilitated by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command, we can sort the buyers and sellers lists respectively by name, priority, and other criteria.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user types in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort-b")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort-s")]),_v(" keyword, followed by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority")]),_v(", or another "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("criteria")]),_v(".\nto sort by.")])}
},function anonymous(
) {
with(this){return _c('h2',{attrs:{"id":"relaxed-parameter-matching"}},[_v("Relaxed parameter matching"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#relaxed-parameter-matching","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"background"}},[_v("Background"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#background","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("In previous versions of the app and in the original brownfield project AB3, fields such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Name")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Email")]),_v("\nhad a validation method on instantiation, which would throw an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IllegalArgumentException")]),_v(" when\nthe provided string did not fit the regex. Although useful, this would often be overzealous, causing potential\nfrustration. Furthermore, this exception, as it halts execution, only informs you of the first field that fails\nto pass, so if you had multiple errors you would have to resolve and re-execute each time.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("In 1.3, we implemented a group of static methods for each parameter, generally named isAppropriate("),_c('em',[_v("Field")]),_v("), which has a\nlooser regex. The result of this boolean check, if it fails, then passes a warning string to the\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandWarnings")]),_v(" class, which collects and stores them in a set. At the end of the execute() method, if the\ncommand encountered any warnings, then they are output into the returned CommandResult.\nThis is then passed through LogicManager into MainWindow for display to the user.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How to implement the warnings")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use a CommandWarnings class to store strings representing warnings\nfor inappropriate but valid fields.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Allows us to hold multiple warnings at a time without halting execution.")]),_v(" "),_c('li',[_v("Cons: Using strings means that poor usage of addWarnings by callers may give nonsensical results.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2 (possible future enhancement):")]),_v(" Have CommandWarnings hold a set of predefined Warning singletons\ninstead of Strings, and")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Constrains the contents of warning messages defensively, ensuring that they are useful.")]),_v(" "),_c('li',[_v("Cons: Not as flexible, not worth the effort of implementing in this early stage of development\n, easy to add as future enhancement.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 3 (proposed):")]),_v(" Use an exception such as InappropriateFieldException, which would be thrown by ParserUtil and\ncaught by the add buyer/seller command parsers, which would then pass a String warning to the command for it to output\nas the CommandResult.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Doesn't require a new class to be created.")]),_v(" "),_c('li',[_v("Cons: To properly account for every field, you would require a Try/Catch block for every single field parsing.\nFurthermore, using exceptions in the backend require switching to kernel mode, slowing down the application (which may be\nsignificant for high-usage cases in the future such as company-wide integration.)")])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is our app "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("RTPM (RealtorTrackerPlusMax)")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(",\nunless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC1 - Add homeowner and house")]),_v("\nSystem: RTPM\nActor: User")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters command to add homeowner and details of the house they are selling.")])]),_v(" "),_c('li',[_c('p',[_v("System adds the entry to the list.")])]),_v(" "),_c('li',[_c('p',[_v("System saves file.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC2 - Add homebuyer and preferences")]),_v("\nSystem: RTPM\nActor: User\n"),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC3 - View buyers")]),_v("\nSystem: RTPM\nActor: User\n"),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Currently, the UI text is cut off if the entries are too long. While this should not usually happen since the user\ncan decide what to enter (nicknames, abbreviations, acronyms, etc.), we plan to accommodate overly long names,\nphone numbers, addresses, emails and house info entries within the UI.")]),_v(" "),_c('li',[_v("Currently, if the user makes a spelling or spacing mistake, the intended prefix of another field is regarded as\npart of the argument for the previous field. We plan to check for misspelled prefixes and prefixes provided as\narguments of other fields and warn the user.")]),_v(" "),_c('li',[_v("Currently, the user is not warned if addresses, names, and house info entries contain only numbers and special\nsymbols. We plan to expand warnings to include warnings for addresses, names and house info entries containing\nonly non-alphabetical characters.")]),_v(" "),_c('li',[_v("Currently, for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("bprio")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sprio")]),_v(", if the user inputs extra arguments\nat the end, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("bprio 1 high low")]),_v(", the app accepts the input and sets the first buyer's priority level to\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("high")]),_v(" instead of warning the user about extra arguments which would be ignored. As such, we plan to warn the user\nif any extra arguments are supplied for the user to double check that their priority input is correct.")]),_v(" "),_c('li',[_v("Currently, attempting to add multiple contacts with long names may cause the app to lag considerably.\nWe plan to optimise the similarity checks for names so that doing so results in less delay.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sun, 12 Nov 2023, 15:35:18 GMT+8]")])])])}
}];

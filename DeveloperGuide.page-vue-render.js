...
with(this){return _c('ol',[_c('li',[_v("Currently, the UI text is cut off if the entries are too long. While this should not usually happen since the user can decide what to enter (nicknames, abbreviations, acronyms, etc.), we plan to accommodate overly long names, phone numbers, addresses, emails and house info entries within the UI.")]),_v(" "),_c('li',[_v("Currently, if the user makes a spelling or spacing mistake, the intended prefix of another field is regarded as part of the argument for the previous field. We plan to check for misspelled prefixes and prefixes provided as arguments of other fields and warn the user.")]),_v(" "),_c('li',[_v("Currently, the user is not warned if addresses, names, and house info entries contain only numbers and special symbols. We plan to expand warnings to include warnings for addresses, names and house info entries containing only non-alphabetical characters")])])}
},function anonymous(
) {
